...
pygame.init()
pygame.display.set_caption("Scarlet a princesa enfeitiçada")
...
def selecionar_velocidade(tecla):
    if tecla == pygame.K_DOWN: #P/ BAIXO
        velocidade_x = 0
        velocidade_y = tamanho_quadrado
    elif tecla == pygame.K_UP:  #P/CIMA
        velocidade_x = 0
        velocidade_y = -tamanho_quadrado
    elif tecla == pygame.K_RIGHT: #P/ DIREITA
        velocidade_x = tamanho_quadrado
        velocidade_y = 0
    elif tecla == pygame.K_LEFT:  #P/ESQUERDA
        velocidade_x = -tamanho_quadrado
        velocidade_y = 0
